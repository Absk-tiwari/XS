      ...
      >
        <div className='wrapper'>
          <div className='discount-info'>
            ...
            <h2>Xytiles Studio develops its own brands</h2>
            <p>
              The Xytiles Studio network is being developed and improved, taking into
            ...
            <p className='discount-info__sm'>
              ...
              and care. Xytiles Studio stores offer their customers the widest and
